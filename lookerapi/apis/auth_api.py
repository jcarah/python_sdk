...
class AuthApi(object):
    ...
    def create_oidc_test_config(self, body, **kwargs):
        ...
        if kwargs.get('callback'):
            return self.create_oidc_test_config_with_http_info(body, **kwargs)
        else:
            (data) = self.create_oidc_test_config_with_http_info(body, **kwargs)
            return data

    def create_oidc_test_config_with_http_info(self, body, **kwargs):
        """
        Create OIDC Test Configuration
        ### Create a OIDC test configuration. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_oidc_test_config_with_http_info(body, callback=callback_function)
    ...
    def create_saml_test_config(self, body, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.create_saml_test_config_with_http_info(body, **kwargs)
        else:
            (data) = self.create_saml_test_config_with_http_info(body, **kwargs)
            return data

    def create_saml_test_config_with_http_info(self, body, **kwargs):
        """
        Create SAML Test Configuration
        ### Create a SAML test configuration. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.create_saml_test_config_with_http_info(body, callback=callback_function)
    ...
    def delete_oidc_test_config(self, test_slug, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_oidc_test_config_with_http_info(test_slug, **kwargs)
        else:
            (data) = self.delete_oidc_test_config_with_http_info(test_slug, **kwargs)
            return data

    def delete_oidc_test_config_with_http_info(self, test_slug, **kwargs):
        """
        Delete OIDC Test Configuration
        ### Delete a OIDC test configuration. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_oidc_test_config_with_http_info(test_slug, callback=callback_function)
    ...
    def delete_saml_test_config(self, test_slug, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.delete_saml_test_config_with_http_info(test_slug, **kwargs)
        else:
            (data) = self.delete_saml_test_config_with_http_info(test_slug, **kwargs)
            return data

    def delete_saml_test_config_with_http_info(self, test_slug, **kwargs):
        """
        Delete SAML Test Configuration
        ### Delete a SAML test configuration. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_saml_test_config_with_http_info(test_slug, callback=callback_function)
    ...
    def fetch_and_parse_saml_idp_metadata(self, body, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.fetch_and_parse_saml_idp_metadata_with_http_info(body, **kwargs)
        else:
            (data) = self.fetch_and_parse_saml_idp_metadata_with_http_info(body, **kwargs)
            return data

    def fetch_and_parse_saml_idp_metadata_with_http_info(self, body, **kwargs):
        """
        Parse SAML IdP Url
        ### Fetch the given url and parse it as a SAML IdP metadata document and return the result. Note that this requires that the url be public or at least at a location where the Looker instance can fetch it without requiring any special authentication. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.fetch_and_parse_saml_idp_metadata_with_http_info(body, callback=callback_function)
    ...
    def force_password_reset_at_next_login_for_all_users(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.force_password_reset_at_next_login_for_all_users(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.force_password_reset_at_next_login_for_all_users_with_http_info(**kwargs)
        else:
            (data) = self.force_password_reset_at_next_login_for_all_users_with_http_info(**kwargs)
            return data

    def force_password_reset_at_next_login_for_all_users_with_http_info(self, **kwargs):
        """
        Force password reset
        ### Force all credentials_email users to reset their login passwords upon their next login. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.force_password_reset_at_next_login_for_all_users_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method force_password_reset_at_next_login_for_all_users" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        resource_path = '/password_config/force_password_reset_at_next_login_for_all_users'.replace('{format}', 'json')
        path_params = {}
    ...
    def ldap_config(self, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.ldap_config_with_http_info(**kwargs)
        else:
            (data) = self.ldap_config_with_http_info(**kwargs)
            return data

    def ldap_config_with_http_info(self, **kwargs):
        """
        Get LDAP Configuration
        ### Get the LDAP configuration.  Looker can be optionally configured to authenticate users against an Active Directory or other LDAP directory server. LDAP setup requires coordination with an administrator of that directory server.  Only Looker administrators can read and update the LDAP configuration.  Configuring LDAP impacts authentication for all users. This configuration should be done carefully.  Looker maintains a single LDAP configuration. It can be read and updated.       Updates only succeed if the new state will be valid (in the sense that all required fields are populated);       it is up to you to ensure that the configuration is appropriate and correct).  LDAP is enabled or disabled for Looker using the **enabled** field.  Looker will never return an **auth_password** field. That value can be set, but never retrieved.  See the [Looker LDAP docs](https://www.looker.com/docs/r/api/ldap_setup) for additional information. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.ldap_config_with_http_info(callback=callback_function)
    ...
    def oidc_config(self, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.oidc_config_with_http_info(**kwargs)
        else:
            (data) = self.oidc_config_with_http_info(**kwargs)
            return data

    def oidc_config_with_http_info(self, **kwargs):
        """
        Get OIDC Configuration
        ### Get the OIDC configuration.  Looker can be optionally configured to authenticate users against an OpenID Connect (OIDC) authentication server. OIDC setup requires coordination with an administrator of that server.  Only Looker administrators can read and update the OIDC configuration.  Configuring OIDC impacts authentication for all users. This configuration should be done carefully.  Looker maintains a single OIDC configuation. It can be read and updated.       Updates only succeed if the new state will be valid (in the sense that all required fields are populated);       it is up to you to ensure that the configuration is appropriate and correct).  OIDC is enabled or disabled for Looker using the **enabled** field. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.oidc_config_with_http_info(callback=callback_function)
    ...
    def oidc_test_config(self, test_slug, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.oidc_test_config_with_http_info(test_slug, **kwargs)
        else:
            (data) = self.oidc_test_config_with_http_info(test_slug, **kwargs)
            return data

    def oidc_test_config_with_http_info(self, test_slug, **kwargs):
        """
        Get OIDC Test Configuration
        ### Get a OIDC test configuration by test_slug. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.oidc_test_config_with_http_info(test_slug, callback=callback_function)
    ...
    def parse_saml_idp_metadata(self, body, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.parse_saml_idp_metadata_with_http_info(body, **kwargs)
        else:
            (data) = self.parse_saml_idp_metadata_with_http_info(body, **kwargs)
            return data

    def parse_saml_idp_metadata_with_http_info(self, body, **kwargs):
        """
        Parse SAML IdP XML
        ### Parse the given xml as a SAML IdP metadata document and return the result. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.parse_saml_idp_metadata_with_http_info(body, callback=callback_function)
    ...
    def password_config(self, **kwargs):
        """
        Get Password Config
        ### Get password config. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.password_config(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.password_config_with_http_info(**kwargs)
        else:
            (data) = self.password_config_with_http_info(**kwargs)
            return data

    def password_config_with_http_info(self, **kwargs):
        """
        Get Password Config
        ### Get password config. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.password_config_with_http_info(callback=callback_function)
        ...
        resource_path = '/password_config'.replace('{format}', 'json')
        path_params = {}
    ...
    def saml_config(self, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.saml_config_with_http_info(**kwargs)
        else:
            (data) = self.saml_config_with_http_info(**kwargs)
            return data

    def saml_config_with_http_info(self, **kwargs):
        """
        Get SAML Configuration
        ### Get the SAML configuration.  Looker can be optionally configured to authenticate users against a SAML authentication server. SAML setup requires coordination with an administrator of that server.  Only Looker administrators can read and update the SAML configuration.  Configuring SAML impacts authentication for all users. This configuration should be done carefully.  Looker maintains a single SAML configuation. It can be read and updated.       Updates only succeed if the new state will be valid (in the sense that all required fields are populated);       it is up to you to ensure that the configuration is appropriate and correct).  SAML is enabled or disabled for Looker using the **enabled** field. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.saml_config_with_http_info(callback=callback_function)
    ...
    def saml_test_config(self, test_slug, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.saml_test_config_with_http_info(test_slug, **kwargs)
        else:
            (data) = self.saml_test_config_with_http_info(test_slug, **kwargs)
            return data

    def saml_test_config_with_http_info(self, test_slug, **kwargs):
        """
        Get SAML Test Configuration
        ### Get a SAML test configuration by test_slug. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.saml_test_config_with_http_info(test_slug, callback=callback_function)
    ...
    def session_config(self, **kwargs):
        """
        Get Session Config
        ### Get session config. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.session_config(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.session_config_with_http_info(**kwargs)
        else:
            (data) = self.session_config_with_http_info(**kwargs)
            return data

    def session_config_with_http_info(self, **kwargs):
        """
        Get Session Config
        ### Get session config. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.session_config_with_http_info(callback=callback_function)
        ...
        resource_path = '/session_config'.replace('{format}', 'json')
        path_params = {}
    ...
    def test_ldap_config_auth(self, body, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.test_ldap_config_auth_with_http_info(body, **kwargs)
        else:
            (data) = self.test_ldap_config_auth_with_http_info(body, **kwargs)
            return data

    def test_ldap_config_auth_with_http_info(self, body, **kwargs):
        """
        Test LDAP Auth
        ### Test the connection authentication settings for an LDAP configuration.  This tests that the connection is possible and that a 'server' account to be used by Looker can       authenticate to the LDAP server given connection and authentication information.  **connection_host**, **connection_port**, and **auth_username**, are required.       **connection_tls** and **auth_password** are optional.  Example: ```json {   \"connection_host\": \"ldap.example.com\",   \"connection_port\": \"636\",   \"connection_tls\": true,   \"auth_username\": \"cn=looker,dc=example,dc=com\",   \"auth_password\": \"secret\" } ```  Looker will never return an **auth_password**. If this request omits the **auth_password** field, then       the **auth_password** value from the active config (if present) will be used for the test.  The active LDAP settings are not modified.  
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.test_ldap_config_auth_with_http_info(body, callback=callback_function)
    ...
    def test_ldap_config_connection(self, body, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.test_ldap_config_connection_with_http_info(body, **kwargs)
        else:
            (data) = self.test_ldap_config_connection_with_http_info(body, **kwargs)
            return data

    def test_ldap_config_connection_with_http_info(self, body, **kwargs):
        """
        Test LDAP Connection
        ### Test the connection settings for an LDAP configuration.  This tests that the connection is possible given a connection_host and connection_port.  **connection_host** and **connection_port** are required. **connection_tls** is optional.  Example: ```json {   \"connection_host\": \"ldap.example.com\",   \"connection_port\": \"636\",   \"connection_tls\": true } ```  No authentication to the LDAP server is attempted.  The active LDAP settings are not modified. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.test_ldap_config_connection_with_http_info(body, callback=callback_function)
    ...
    def test_ldap_config_user_auth(self, body, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.test_ldap_config_user_auth_with_http_info(body, **kwargs)
        else:
            (data) = self.test_ldap_config_user_auth_with_http_info(body, **kwargs)
            return data

    def test_ldap_config_user_auth_with_http_info(self, body, **kwargs):
        """
        Test LDAP User Auth
        ### Test the user authentication settings for an LDAP configuration.  This test accepts a full LDAP configuration along with a username/password pair and attempts to       authenticate the user with the LDAP server. The configuration is validated before attempting the       authentication.  Looker will never return an **auth_password**. If this request omits the **auth_password** field, then       the **auth_password** value from the active config (if present) will be used for the test.  **test_ldap_user** and **test_ldap_password** are required.  The active LDAP settings are not modified.  
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.test_ldap_config_user_auth_with_http_info(body, callback=callback_function)
    ...
    def test_ldap_config_user_info(self, body, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.test_ldap_config_user_info_with_http_info(body, **kwargs)
        else:
            (data) = self.test_ldap_config_user_info_with_http_info(body, **kwargs)
            return data

    def test_ldap_config_user_info_with_http_info(self, body, **kwargs):
        """
        Test LDAP User Info
        ### Test the user authentication settings for an LDAP configuration without authenticating the user.  This test will let you easily test the mapping for user properties and roles for any user without      needing to authenticate as that user.  This test accepts a full LDAP configuration along with a username and attempts to find the full info      for the user from the LDAP server without actually authenticating the user. So, user password is not      required.The configuration is validated before attempting to contact the server.  **test_ldap_user** is required.  The active LDAP settings are not modified.  
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.test_ldap_config_user_info_with_http_info(body, callback=callback_function)
    ...
    def update_ldap_config(self, body, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_ldap_config_with_http_info(body, **kwargs)
        else:
            (data) = self.update_ldap_config_with_http_info(body, **kwargs)
            return data

    def update_ldap_config_with_http_info(self, body, **kwargs):
        """
        Update LDAP Configuration
        ### Update the LDAP configuration.  Configuring LDAP impacts authentication for all users. This configuration should be done carefully.  Only Looker administrators can read and update the LDAP configuration.  LDAP is enabled or disabled for Looker using the **enabled** field.  It is **highly** recommended that any LDAP setting changes be tested using the APIs below before being set globally.  See the [Looker LDAP docs](https://www.looker.com/docs/r/api/ldap_setup) for additional information. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_ldap_config_with_http_info(body, callback=callback_function)
    ...
    def update_oidc_config(self, body, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_oidc_config_with_http_info(body, **kwargs)
        else:
            (data) = self.update_oidc_config_with_http_info(body, **kwargs)
            return data

    def update_oidc_config_with_http_info(self, body, **kwargs):
        """
        Update OIDC Configuration
        ### Update the OIDC configuration.  Configuring OIDC impacts authentication for all users. This configuration should be done carefully.  Only Looker administrators can read and update the OIDC configuration.  OIDC is enabled or disabled for Looker using the **enabled** field.  It is **highly** recommended that any OIDC setting changes be tested using the APIs below before being set globally. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_oidc_config_with_http_info(body, callback=callback_function)
    ...
    def update_password_config(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_password_config(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param PasswordConfig body: Password Config (required)
        :return: PasswordConfig
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_password_config_with_http_info(body, **kwargs)
        else:
            (data) = self.update_password_config_with_http_info(body, **kwargs)
            return data

    def update_password_config_with_http_info(self, body, **kwargs):
        """
        Update Password Config
        ### Update password config. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_password_config_with_http_info(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_password_config" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_password_config`")
    ...
    def update_saml_config(self, body, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_saml_config_with_http_info(body, **kwargs)
        else:
            (data) = self.update_saml_config_with_http_info(body, **kwargs)
            return data

    def update_saml_config_with_http_info(self, body, **kwargs):
        """
        Update SAML Configuration
        ### Update the SAML configuration.  Configuring SAML impacts authentication for all users. This configuration should be done carefully.  Only Looker administrators can read and update the SAML configuration.  SAML is enabled or disabled for Looker using the **enabled** field.  It is **highly** recommended that any SAML setting changes be tested using the APIs below before being set globally. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_saml_config_with_http_info(body, callback=callback_function)
    ...
    def update_session_config(self, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_session_config(body, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param SessionConfig body: Session Config (required)
        :return: SessionConfig
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_session_config_with_http_info(body, **kwargs)
        else:
            (data) = self.update_session_config_with_http_info(body, **kwargs)
            return data

    def update_session_config_with_http_info(self, body, **kwargs):
        """
        Update Session Config
        ### Update session config. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_session_config_with_http_info(body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_session_config" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_session_config`")
