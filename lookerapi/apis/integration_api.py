...
class IntegrationApi(object):
    ...
    def test_integration(self, integration_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.test_integration_with_http_info(integration_id, **kwargs)
        else:
            (data) = self.test_integration_with_http_info(integration_id, **kwargs)
            return data

    def test_integration_with_http_info(self, integration_id, **kwargs):
        """
        Test integration
        Tests the integration to make sure all the settings are working.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.test_integration_with_http_info(integration_id, callback=callback_function)
