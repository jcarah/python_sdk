...
class UserAttribute(object):
    ...
    """
    def __init__(self, id=None, name=None, label=None, type=None, default_value=None, is_system=None, value_is_hidden=None, user_can_view=None, user_can_edit=None, hidden_value_domain_whitelist=None, can=None):
        """
